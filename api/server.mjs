...
var Role, BookingStatus, UserStatus;
...
var createProfile, createAvailability, updateAvailability, updateTutorCategories, getAllTutors, getTutorById, tutorService;
var init_tutor_service = __esm({
  "src/modules/tutors/tutor.service.ts"() {
    ...
    createAvailability = async (id, { startTime, endTime }) => {
    ...
    updateAvailability = async (id, tutorId, { startTime, endTime }) => {
      if (startTime >= endTime) {
        throw new Error("Invalid input date range. Please check again.");
      }
      const tutorProfile = await prisma.tutorProfile.findUnique({
    ...
    updateTutorCategories = async (userId, categoryIds) => {
      const tutorProfile = await prisma.tutorProfile.findUnique({
        where: {
          userId
        }
...
var createProfile2, createAvailability2, updateAvailability2, updateTutorCategories2, getAllTutors2, getTutorById2, tutorController;
var init_tutor_controller = __esm({
  "src/modules/tutors/tutor.controller.ts"() {
    "use strict";
    init_tutor_service();
    createProfile2 = async (req, res) => {
      try {
        if (!req.user) {
    ...
    updateAvailability2 = async (req, res) => {
      try {
        if (!req.user) {
          return res.status(400).json({
            error: "Unauthorized!"
    ...
    updateTutorCategories2 = async (req, res) => {
      try {
        if (!req.user) {
          return res.status(400).json({
            error: "Unauthorized!"
...
var requireAuth, requireAuth_default;
var init_requireAuth = __esm({
  "src/middlewares/requireAuth.ts"() {
    ...
    requireAuth_default = requireAuth;
  }
});

// src/modules/tutors/tutor.route.ts
import express from "express";
var router, tutorRouter;
...
var createCategory, getAllCategories, updateCategoryStatus, categoryService;
...
var createCategory2, getAllCategories2, updateCategoryStatus2, categoryController;
var init_category_controller = __esm({
  "src/modules/categories/category.controller.ts"() {
    ...
    updateCategoryStatus2 = async (req, res) => {
      try {
        const { id } = req.params;
...
var createBooking, getMyBookings, getBookingById, updateBookingStatus, bookingService;
var init_booking_service = __esm({
  "src/modules/bookings/booking.service.ts"() {
    "use strict";
    init_enums();
    init_prisma();
    createBooking = async (studentId, availabilityId) => {
    ...
    getMyBookings = async (userId, role) => {
    ...
    getBookingById = async (bookingId, userId, role) => {
    ...
    updateBookingStatus = async (bookingId, userId, role) => {
      const booking = await prisma.booking.findUniqueOrThrow({
        where: { id: bookingId },
        include: {
          availability: true
...
var createBooking2, getMyBookings2, getBookingById2, updateBookingStatus2, bookingController;
var init_booking_controller = __esm({
  "src/modules/bookings/booking.controller.ts"() {
    ...
    updateBookingStatus2 = async (req, res) => {
      try {
        if (!req.user) {
          return res.status(400).json({
            error: "Unauthorized!"
...
var init_review_route = __esm({
  "src/modules/reviews/review.route.ts"() {
    ...
    reviewRouter = router4;
  }
});

// src/modules/admin/admin.service.ts
var getAllUsers, updateUser, updateTutorFeaturedStatus, adminService;
var init_admin_service = __esm({
  "src/modules/admin/admin.service.ts"() {
    ...
    updateTutorFeaturedStatus = async (tutorProfileId, isFeatured) => {
      const tutorProfile = await prisma.tutorProfile.findUniqueOrThrow({
...
var getAllUsers2, updateUser2, updateTutorFeaturedStatus2, adminController;
var init_admin_controller = __esm({
  "src/modules/admin/admin.controller.ts"() {
    ...
    updateTutorFeaturedStatus2 = async (req, res) => {
      try {
...
var updateMe2, userController;
var init_user_controller = __esm({
  "src/modules/users/user.controller.ts"() {
    "use strict";
    init_user_service();
    updateMe2 = async (req, res) => {
      try {
        if (!req.user) {
          return res.status(400).json({
            error: "Unauthorized!"
